...
## [17.5.0](https://github.com/seblyng/codecompanion.nvim/compare/v17.23.0...v17.5.0) (2025-09-17)


### ⚠ BREAKING CHANGES

* remove support for nvim-0.10 ([#1639](https://github.com/seblyng/codecompanion.nvim/issues/1639))
* **chat:** move the `goto_file_action` to `strategies.chat.opts`
* **chat:** move `opts.goto_file_action` to `strategies.chat.opts` ([#1571](https://github.com/seblyng/codecompanion.nvim/issues/1571))
* **chat:** reuse existing tabs when jumping to a file. ([#1569](https://github.com/seblyng/codecompanion.nvim/issues/1569))
* **tools:** move to function calling ([#1141](https://github.com/seblyng/codecompanion.nvim/issues/1141))

### Features

* **acp:** add support for Claude Code ([#2079](https://github.com/seblyng/codecompanion.nvim/issues/2079)) ([0e4abfb](https://github.com/seblyng/codecompanion.nvim/commit/0e4abfb558f95fea9804a4239447c3f9a71013d2))
* **acp:** tighter integration with the protocol ([#2054](https://github.com/seblyng/codecompanion.nvim/issues/2054)) ([626b1b0](https://github.com/seblyng/codecompanion.nvim/commit/626b1b07e96e19324e5bb3279ab3b525a6ea759d))
* **action_palette:** add `fzf_lua` provider ([#1443](https://github.com/seblyng/codecompanion.nvim/issues/1443)) ([03caa41](https://github.com/seblyng/codecompanion.nvim/commit/03caa41555d6615006d0ac8f6fcfee317cb967f0))
* **action_palette:** Add snacks.nvim as provider ([#1380](https://github.com/seblyng/codecompanion.nvim/issues/1380)) ([5b4a004](https://github.com/seblyng/codecompanion.nvim/commit/5b4a004ea082a0608aa98bb9041f79e56676cfeb))
* **action_palette:** title is configurable ([#1937](https://github.com/seblyng/codecompanion.nvim/issues/1937)) ([f3b1ff0](https://github.com/seblyng/codecompanion.nvim/commit/f3b1ff08e458708b51de4c7abf1be4ad5d25242a))
* **adapters:** :boom: add tool support to Ollama ([#1585](https://github.com/seblyng/codecompanion.nvim/issues/1585)) ([e325370](https://github.com/seblyng/codecompanion.nvim/commit/e325370b8325697cb2f6becd13f267e6a12a0393))
* **adapters:** add function calling to Novita ([#1888](https://github.com/seblyng/codecompanion.nvim/issues/1888)) ([c6fcb28](https://github.com/seblyng/codecompanion.nvim/commit/c6fcb28a69f0ceb5ee43922a8aadc7c663942246))
* **adapters:** add gemini-2.5-flash and set as new default ([#1686](https://github.com/seblyng/codecompanion.nvim/issues/1686)) ([fb98d6c](https://github.com/seblyng/codecompanion.nvim/commit/fb98d6c03f6039939e676f1257c76d8480a3da4f))
* **adapters:** add gemini-2.5-pro-preview-06-05 ([#1605](https://github.com/seblyng/codecompanion.nvim/issues/1605)) ([fa8af3b](https://github.com/seblyng/codecompanion.nvim/commit/fa8af3bbaa70773a5d104ad8fdc567d30be260b4))
* **adapters:** add new Anthropic models ([#1488](https://github.com/seblyng/codecompanion.nvim/issues/1488)) ([70d52e0](https://github.com/seblyng/codecompanion.nvim/commit/70d52e00c23a6df9ccf3bc927e2658b320764302))
* **adapters:** add tool support to Azure OpenAI ([#1737](https://github.com/seblyng/codecompanion.nvim/issues/1737)) ([2c7e9b1](https://github.com/seblyng/codecompanion.nvim/commit/2c7e9b1aa9fa1f5a2b4d82f3f4e065cb0c8bc2b7))
* **adapters:** add tool support to HuggingFace ([#1907](https://github.com/seblyng/codecompanion.nvim/issues/1907)) ([afa34eb](https://github.com/seblyng/codecompanion.nvim/commit/afa34ebe3c48d74dc7e1c8b26d74f7f3a02cb531))
* **adapters:** add vision support ([#1455](https://github.com/seblyng/codecompanion.nvim/issues/1455)) ([1a4f0a4](https://github.com/seblyng/codecompanion.nvim/commit/1a4f0a44b1e52d1c569ce2f66b03b6804e74b183))
* **adapters:** allow hiding of acp adapters ([#2086](https://github.com/seblyng/codecompanion.nvim/issues/2086)) ([aa7c937](https://github.com/seblyng/codecompanion.nvim/commit/aa7c937ac9f73e061da74dec6ab5f1fc6909dd37))
* **adapters:** can automatically choose default model when switching adapters ([#1369](https://github.com/seblyng/codecompanion.nvim/issues/1369)) ([90e82ab](https://github.com/seblyng/codecompanion.nvim/commit/90e82abf4d65b64b0986a5be0981ba13e84eee8b))
* **adapters:** can use adapter.opts.request to override Client:request ([#1469](https://github.com/seblyng/codecompanion.nvim/issues/1469)) ([ec73b64](https://github.com/seblyng/codecompanion.nvim/commit/ec73b64df3d0767eb0a5b42d942f9e02970ee95c))
* **adapters:** new copilot default is gpt-4.1 ([#1540](https://github.com/seblyng/codecompanion.nvim/issues/1540)) ([15b0614](https://github.com/seblyng/codecompanion.nvim/commit/15b06141cb9d66ebb3b3038fbe4fa9cd0ee0fc15))
* **adapters:** Ollama adapter has support for `think` and more hyperparameters ([#1829](https://github.com/seblyng/codecompanion.nvim/issues/1829)) ([408b402](https://github.com/seblyng/codecompanion.nvim/commit/408b402da023ae41f13b4a071e4c79d3b0b78693))
* **adapters:** set Copilot default model to `gpt-4.1` ([bd14edb](https://github.com/seblyng/codecompanion.nvim/commit/bd14edb82ea07423c5c0f7484ef885a895374719))
* **adapters:** support Copilot enterprise ([#1533](https://github.com/seblyng/codecompanion.nvim/issues/1533)) ([7572e35](https://github.com/seblyng/codecompanion.nvim/commit/7572e35f22395ad2ab095e75b419a70a00ca2036))
* **adapter:** support for OpenAI gpt-5 models ([#1993](https://github.com/seblyng/codecompanion.nvim/issues/1993)) ([69d7579](https://github.com/seblyng/codecompanion.nvim/commit/69d75795d82bc7d1ff77cf4461d59104b432c740))
* **adapters:** users can specify models for strategies ([#1518](https://github.com/seblyng/codecompanion.nvim/issues/1518)) ([763c81b](https://github.com/seblyng/codecompanion.nvim/commit/763c81b4823af3e3ef9cfb3f55f15f7f8f8b4b15))
* add chat ID to chat opened/hidden events ([17f7cbb](https://github.com/seblyng/codecompanion.nvim/commit/17f7cbb6cabdc12195f164acf4c59c7c7c205b64))
* add extensions api ([#1290](https://github.com/seblyng/codecompanion.nvim/issues/1290)) ([96bda85](https://github.com/seblyng/codecompanion.nvim/commit/96bda85c8bc77ac7a8f0b1a431c38e2c4103ad90))
* **chat:** :sparkles: add memory ([#2093](https://github.com/seblyng/codecompanion.nvim/issues/2093)) ([b3fe1b0](https://github.com/seblyng/codecompanion.nvim/commit/b3fe1b020262ef970e9bcd43f0faec856a5bd472))
* **chat:** add `CodeCompanionChatDone` event ([#1881](https://github.com/seblyng/codecompanion.nvim/issues/1881)) ([e23e8e5](https://github.com/seblyng/codecompanion.nvim/commit/e23e8e5a5643b089607f21f576f6e63174cc44dc))
* **chat:** add `collapse_tools` setting for tool groups ([#1614](https://github.com/seblyng/codecompanion.nvim/issues/1614)) ([f1442c7](https://github.com/seblyng/codecompanion.nvim/commit/f1442c743f0f40132d07b42ccf99e450b648fcf6))
* **chat:** add copilot usage statistics with `gS` keymap ([#1677](https://github.com/seblyng/codecompanion.nvim/issues/1677)) ([8602a50](https://github.com/seblyng/codecompanion.nvim/commit/8602a50cacf111c69f35e305d1556afd9fa1f1a1))
* **chat:** add floating diff layout with focus effects ([#2016](https://github.com/seblyng/codecompanion.nvim/issues/2016)) ([d556e1b](https://github.com/seblyng/codecompanion.nvim/commit/d556e1b2c0ac85037a589ae15dae461255297bc1))
* **chat:** add global metadata ([#1973](https://github.com/seblyng/codecompanion.nvim/issues/1973)) ([f962b2e](https://github.com/seblyng/codecompanion.nvim/commit/f962b2e33ffd9dfa91641fe21af648436a016906))
* **chat:** add keymap to jump to file under cursor ([#1408](https://github.com/seblyng/codecompanion.nvim/issues/1408)) ([4c54348](https://github.com/seblyng/codecompanion.nvim/commit/4c5434883fff08bc9814fb71aff0f51518276acb))
* **chat:** add restore function to ensure a chat buffer can be made visible ([#1816](https://github.com/seblyng/codecompanion.nvim/issues/1816)) ([f37b8b9](https://github.com/seblyng/codecompanion.nvim/commit/f37b8b91d77745b5e5fc816272f50b9826ada6d9))
* **chat:** add support for Agent Client Protocol ([#2025](https://github.com/seblyng/codecompanion.nvim/issues/2025)) ([ad468b1](https://github.com/seblyng/codecompanion.nvim/commit/ad468b141918af8a5da9d98fcd15a985e0139c76))
* **chat:** add support for Agent Client Protocol ([#2025](https://github.com/seblyng/codecompanion.nvim/issues/2025)) ([c71f51f](https://github.com/seblyng/codecompanion.nvim/commit/c71f51f0c4b35f2c35ed0c2f1a4d911f56e55866))
* **chat:** call slash commands with keymaps ([#1412](https://github.com/seblyng/codecompanion.nvim/issues/1412)) ([598af68](https://github.com/seblyng/codecompanion.nvim/commit/598af68b53394cfd43f7a098dcd463da86c5dc3f))
* **chat:** can preload with `default_tools` ([#1610](https://github.com/seblyng/codecompanion.nvim/issues/1610)) ([68c12a0](https://github.com/seblyng/codecompanion.nvim/commit/68c12a03a738aaeffe429c45b9f0c14ce00b0132))
* **chat:** can set default params for variables ([#1516](https://github.com/seblyng/codecompanion.nvim/issues/1516)) ([c0549d5](https://github.com/seblyng/codecompanion.nvim/commit/c0549d54203160020b4214d3e8827b2103a95b97))
* **chat:** chat buffer acts more like a normal buffer ([#1556](https://github.com/seblyng/codecompanion.nvim/issues/1556)) ([ebcdd78](https://github.com/seblyng/codecompanion.nvim/commit/ebcdd78a9d5d0d95c64fe9a106999b9f9603d2f3))
* **chat:** context can be folded in the chat buffer ([#1911](https://github.com/seblyng/codecompanion.nvim/issues/1911)) ([acfa69b](https://github.com/seblyng/codecompanion.nvim/commit/acfa69b6f712035dfc24c1aa2da3c8e5094e1699))
* **chat:** decorate your prompts ([080e8c9](https://github.com/seblyng/codecompanion.nvim/commit/080e8c9324ce40dd6b5e9aaf4ea27450707a55a7))
* **chat:** handle buffer deletion of chat buffers ([#1745](https://github.com/seblyng/codecompanion.nvim/issues/1745)) ([dbc7957](https://github.com/seblyng/codecompanion.nvim/commit/dbc7957ee92ddce403405c5c6d91ba7dccb278c7))
* **chat:** improve buffer variables ([#1967](https://github.com/seblyng/codecompanion.nvim/issues/1967)) ([5d2f49a](https://github.com/seblyng/codecompanion.nvim/commit/5d2f49a770c41fa26cb9200c592f0dca7af8d5a2))
* **chat:** remember cursor position when toggling ([#1523](https://github.com/seblyng/codecompanion.nvim/issues/1523)) ([51fb1df](https://github.com/seblyng/codecompanion.nvim/commit/51fb1dfa7227ace2e6635c8fcc75cc2ab1b607c6))
* **chat:** reuse existing tabs when jumping to a file. ([#1569](https://github.com/seblyng/codecompanion.nvim/issues/1569)) ([8747d88](https://github.com/seblyng/codecompanion.nvim/commit/8747d8871e310942996431d5374001a8b29ab0b7))
* **chat:** simplify watchers to use unified diffs ([#1583](https://github.com/seblyng/codecompanion.nvim/issues/1583)) ([81b817b](https://github.com/seblyng/codecompanion.nvim/commit/81b817b4186f85d4b2880516054b0e34bb27e60d))
* **chat:** support `:map-arguments` in keymaps ([#1572](https://github.com/seblyng/codecompanion.nvim/issues/1572)) ([d8e94cf](https://github.com/seblyng/codecompanion.nvim/commit/d8e94cfff7525ff5fdcc376093666c2cf57bb0e5))
* **chat:** support `pre_hook` in prompt library items ([#1964](https://github.com/seblyng/codecompanion.nvim/issues/1964)) ([8b60fcc](https://github.com/seblyng/codecompanion.nvim/commit/8b60fcc972ae08604505c4626b0e885e3d7396bf))
* **chat:** system prompt has improved knowledge ([#2038](https://github.com/seblyng/codecompanion.nvim/issues/2038)) ([32ebe36](https://github.com/seblyng/codecompanion.nvim/commit/32ebe36019b224d41943f2535bb306dce78144f9))
* **chat:** system prompt has improved knowledge ([#2038](https://github.com/seblyng/codecompanion.nvim/issues/2038)) ([71eb108](https://github.com/seblyng/codecompanion.nvim/commit/71eb108af3157fb268dda9bb6a0d762314bb70a2))
* **chat:** tool output can be folded ([#1665](https://github.com/seblyng/codecompanion.nvim/issues/1665)) ([a87ebc7](https://github.com/seblyng/codecompanion.nvim/commit/a87ebc73ffc796bb5020cb083e2a5ef3c2c7e9bf))
* **diff:** native inline diff and super diff ([#1884](https://github.com/seblyng/codecompanion.nvim/issues/1884)) ([6bc36af](https://github.com/seblyng/codecompanion.nvim/commit/6bc36af3898d6ad3e813f0d19c7e32972731ef37))
* **gemini:** add gemini-2.5-flash ([#1347](https://github.com/seblyng/codecompanion.nvim/issues/1347)) ([b4d96cb](https://github.com/seblyng/codecompanion.nvim/commit/b4d96cbdca7ddc7870b0db0aded898ce9e6ea709))
* **inline:** multiple variables, better completion and `#{clipboard}` ([#1981](https://github.com/seblyng/codecompanion.nvim/issues/1981)) ([c5aa3c6](https://github.com/seblyng/codecompanion.nvim/commit/c5aa3c6231f861f2ab20c886e0776c5b2f43bbe8))
* **openai:** update models ([#1346](https://github.com/seblyng/codecompanion.nvim/issues/1346)) ([b114cd1](https://github.com/seblyng/codecompanion.nvim/commit/b114cd1c24e784ef6ad0af9770bc141f5b81affd))
* **prompt_library:** can set adapter on workflows ([#2071](https://github.com/seblyng/codecompanion.nvim/issues/2071)) ([2bd4983](https://github.com/seblyng/codecompanion.nvim/commit/2bd49835b915f95ee533b6773cbfef175d6c29d7))
* **prompt_library:** custom prompts can add references ([#1384](https://github.com/seblyng/codecompanion.nvim/issues/1384)) ([3117350](https://github.com/seblyng/codecompanion.nvim/commit/31173502852f0d524e9e74e51255177f094c45e0))
* **prompts:** custom intro messages and no user prompt requirements ([#1927](https://github.com/seblyng/codecompanion.nvim/issues/1927)) ([17dc923](https://github.com/seblyng/codecompanion.nvim/commit/17dc923059ec1b793d9f881785571493adfca4de))
* **providers:** add coc.nvim ([#1421](https://github.com/seblyng/codecompanion.nvim/issues/1421)) ([c22d2a6](https://github.com/seblyng/codecompanion.nvim/commit/c22d2a675f76a97ede327a49baddec02ecd6f3f5))
* **slash_cmd:** workspaces can now take user prompts ([#2039](https://github.com/seblyng/codecompanion.nvim/issues/2039)) ([00d0105](https://github.com/seblyng/codecompanion.nvim/commit/00d0105e96ed4685b8bc5dd4ca1acfed1db7598c))
* **slash_cmd:** workspaces can now take user prompts ([#2039](https://github.com/seblyng/codecompanion.nvim/issues/2039)) ([529902d](https://github.com/seblyng/codecompanion.nvim/commit/529902da176f411052d3de00a315c7fe5c7d5bd3))
* **slash_command:** new `/quickfix` command ([#1600](https://github.com/seblyng/codecompanion.nvim/issues/1600)) ([6384dc0](https://github.com/seblyng/codecompanion.nvim/commit/6384dc0d5b150394403e5ab3bc89bfad301634ea))
* **slash_commands:** add Telescope provider for `/image` ([#1542](https://github.com/seblyng/codecompanion.nvim/issues/1542)) ([a12d3aa](https://github.com/seblyng/codecompanion.nvim/commit/a12d3aa9a0825ae72733fcffc646615bc3bee484))
* **slash_commands:** better caching and restoring of URLs ([#1491](https://github.com/seblyng/codecompanion.nvim/issues/1491)) ([d39890c](https://github.com/seblyng/codecompanion.nvim/commit/d39890cb432801cfe5b2a97104289e1cc4b9c415))
* **slash_commands:** for `/fetch` only show cache option if cached files exist ([#1582](https://github.com/seblyng/codecompanion.nvim/issues/1582)) ([f022807](https://github.com/seblyng/codecompanion.nvim/commit/f0228073aeb2b577425ace676c34654b2e1a308d))
* **tools:** `[@editor](https://github.com/editor)` tool merges with `[@insert](https://github.com/insert)_edit_into_file` ([#1586](https://github.com/seblyng/codecompanion.nvim/issues/1586)) ([bec6cd1](https://github.com/seblyng/codecompanion.nvim/commit/bec6cd124da650dc25472e03f4416cbe27574ef8))
* **tools:** `insert_edit_into_file` tool now saves the buffer ([#1813](https://github.com/seblyng/codecompanion.nvim/issues/1813)) ([f7c89b4](https://github.com/seblyng/codecompanion.nvim/commit/f7c89b4a17d040ba4288f60b08c138b8b94bde4a))
* **tools:** `web_search` tool can search specific sites ([#1741](https://github.com/seblyng/codecompanion.nvim/issues/1741)) ([6ef907f](https://github.com/seblyng/codecompanion.nvim/commit/6ef907fca6480dd11dc8f7a3048fec23f8a39b29))
* **tools:** add `[@next](https://github.com/next)_edit_suggestion` tool ([#1570](https://github.com/seblyng/codecompanion.nvim/issues/1570)) ([600e7b2](https://github.com/seblyng/codecompanion.nvim/commit/600e7b2d55816fa3b8103ef898aaaa31a224224f))
* **tools:** add `fetch_webpage` ([#1837](https://github.com/seblyng/codecompanion.nvim/issues/1837)) ([31fdc34](https://github.com/seblyng/codecompanion.nvim/commit/31fdc343e8aba7c3c1dcabbf13a1c7a6379d077b))
* **tools:** add `file_search` tool ([#1613](https://github.com/seblyng/codecompanion.nvim/issues/1613)) ([3582a2c](https://github.com/seblyng/codecompanion.nvim/commit/3582a2c465fe8900ad70e24877d48247abd608c9))
* **tools:** add `get_changed_files` tool ([#1777](https://github.com/seblyng/codecompanion.nvim/issues/1777)) ([ed5c493](https://github.com/seblyng/codecompanion.nvim/commit/ed5c493eaf54b10b56f1489fdeac3689cd583807))
* **tools:** add `grep_search` tool ([#1651](https://github.com/seblyng/codecompanion.nvim/issues/1651)) ([98eb86c](https://github.com/seblyng/codecompanion.nvim/commit/98eb86cd5e66aa0f2bc3c47eb699ea81c99b74db))
* **tools:** add `list_code_usages` tool ([#1696](https://github.com/seblyng/codecompanion.nvim/issues/1696)) ([16b51b0](https://github.com/seblyng/codecompanion.nvim/commit/16b51b016d3bb1200e8c9350c5ced97f481916fe))
* **tools:** add tavily adapter and `[@web](https://github.com/web)_search` tool ([#1279](https://github.com/seblyng/codecompanion.nvim/issues/1279)) ([a5a8701](https://github.com/seblyng/codecompanion.nvim/commit/a5a8701bf8814ff0ba9bf5f76b3a3deedf3e5f28))
* **tools:** auto_tool_mode now auto submits ([#1580](https://github.com/seblyng/codecompanion.nvim/issues/1580)) ([1b2ab64](https://github.com/seblyng/codecompanion.nvim/commit/1b2ab6445dac16908b2136bd7c071e4dcb7f38d6))
* **tools:** can be conditionally loaded ([#1647](https://github.com/seblyng/codecompanion.nvim/issues/1647)) ([40ba4fc](https://github.com/seblyng/codecompanion.nvim/commit/40ba4fc7e7749a089f23123593d9a6c85140fcfc))
* **tools:** can load tools via relative paths ([#1552](https://github.com/seblyng/codecompanion.nvim/issues/1552)) ([7991e53](https://github.com/seblyng/codecompanion.nvim/commit/7991e53c0270db489b94e1a26c0d1608aa2d6206))
* **tools:** improve auto-submit and turn on by default ([#1539](https://github.com/seblyng/codecompanion.nvim/issues/1539)) ([3388e15](https://github.com/seblyng/codecompanion.nvim/commit/3388e1562aaa6d6deab90e8ad141439ed2bcac2f))
* **tools:** move to function calling ([#1141](https://github.com/seblyng/codecompanion.nvim/issues/1141)) ([4fdf370](https://github.com/seblyng/codecompanion.nvim/commit/4fdf3707f6d8492b34629580935220c13dcac490))
* **tools:** tools have their own system prompt ([b316283](https://github.com/seblyng/codecompanion.nvim/commit/b316283d9a0bee7fe05b452f1f7414d168f1cc83))
* **ui:** chat buffer can be sticky when navigating tabs ([#1842](https://github.com/seblyng/codecompanion.nvim/issues/1842)) ([71fb6a8](https://github.com/seblyng/codecompanion.nvim/commit/71fb6a80894c584d23ea55d4e8d3448cbb04eeaf))
* **ui:** customize chat buffer window config when opening ([#1678](https://github.com/seblyng/codecompanion.nvim/issues/1678)) ([3a10ec9](https://github.com/seblyng/codecompanion.nvim/commit/3a10ec951a0285f149a6f76ba3cf544b3e4b7c63))
* **ui:** fold reasoning content ([#2020](https://github.com/seblyng/codecompanion.nvim/issues/2020)) ([ad52c4f](https://github.com/seblyng/codecompanion.nvim/commit/ad52c4f5ca409784cb0940c9d0a62b514382dfec))
* **ui:** fold reasoning content ([#2020](https://github.com/seblyng/codecompanion.nvim/issues/2020)) ([b7bab43](https://github.com/seblyng/codecompanion.nvim/commit/b7bab43133fcc8e7baaba62b8148ccda1c381f61))
* **workspaces:** files can be opened as buffers ([#1708](https://github.com/seblyng/codecompanion.nvim/issues/1708)) ([2ea49ff](https://github.com/seblyng/codecompanion.nvim/commit/2ea49ff2063100757e71b0e327b7a32a1d566a9d))


### Bug Fixes

* **acp:** fs/read_text_file returning empty string ([#2058](https://github.com/seblyng/codecompanion.nvim/issues/2058)) ([a50f547](https://github.com/seblyng/codecompanion.nvim/commit/a50f547b4e4b525ad781ef57577254d8a4e769fa))
* **action_palette:** mini_pick handles picker actions ([#1944](https://github.com/seblyng/codecompanion.nvim/issues/1944)) ([3d336e2](https://github.com/seblyng/codecompanion.nvim/commit/3d336e25a15ec7862403d674aacb31a20233c06b))
* **adapter:** copilot unauthorized token expired ([#1789](https://github.com/seblyng/codecompanion.nvim/issues/1789)) ([d455d71](https://github.com/seblyng/codecompanion.nvim/commit/d455d71f5887063b08da3fc3cd60548460f1c875))
* **adapters:** `gpt-5-nano` streaming error ([#2017](https://github.com/seblyng/codecompanion.nvim/issues/2017)) ([ad2f08c](https://github.com/seblyng/codecompanion.nvim/commit/ad2f08c5d401708c1bec3b7fb2f6e96132cb4efb))
* **adapters:** copilot return endpoints from github token ([#2078](https://github.com/seblyng/codecompanion.nvim/issues/2078)) ([19eb675](https://github.com/seblyng/codecompanion.nvim/commit/19eb6754df40ef54e2af0026b0d1916f2989df36))
* **adapters:** enable OpenAI vision support ([#1486](https://github.com/seblyng/codecompanion.nvim/issues/1486)) ([f8e14ae](https://github.com/seblyng/codecompanion.nvim/commit/f8e14ae0be51c0f65b0284f787277407db30ace7))
* **adapters:** fix streaming for gemini adapter ([#1561](https://github.com/seblyng/codecompanion.nvim/issues/1561)) ([585fade](https://github.com/seblyng/codecompanion.nvim/commit/585fadef1940a66216124bdbd1bace55be3b1e73))
* **adapters:** handle choices as function in reasoning for OpenAI ([#1902](https://github.com/seblyng/codecompanion.nvim/issues/1902)) ([ea99a1b](https://github.com/seblyng/codecompanion.nvim/commit/ea99a1b4b341286df9d39dfe101c649bf868d39b))
* **adapters:** improve resolving adapters ([#1367](https://github.com/seblyng/codecompanion.nvim/issues/1367)) ([2c296ba](https://github.com/seblyng/codecompanion.nvim/commit/2c296ba17c4bc581eee11fc90683e5b130f65d89))
* **adapters:** missing models in copilot ([#1899](https://github.com/seblyng/codecompanion.nvim/issues/1899)) ([30f7cc7](https://github.com/seblyng/codecompanion.nvim/commit/30f7cc7b768f4f0e694c1841e316d0cda91d7323))
* **adapters:** ollama model selection when changing adapter ([#1890](https://github.com/seblyng/codecompanion.nvim/issues/1890)) ([2695b92](https://github.com/seblyng/codecompanion.nvim/commit/2695b9221ba45071d7aefee49ad20880278e2344))
* **adapters:** ollama reasoning output ([#1950](https://github.com/seblyng/codecompanion.nvim/issues/1950)) ([940159d](https://github.com/seblyng/codecompanion.nvim/commit/940159de970105f9499f4b7e6dc980a70f50ba9e))
* **adapters:** reasoning output and tool calls in anthropic ([#1807](https://github.com/seblyng/codecompanion.nvim/issues/1807)) ([5717527](https://github.com/seblyng/codecompanion.nvim/commit/5717527ba6b1086ed748dd3b1390d0f431ec46cb)), closes [#1752](https://github.com/seblyng/codecompanion.nvim/issues/1752)
* **adapters:** reduce copilot premium request consumption ([#1738](https://github.com/seblyng/codecompanion.nvim/issues/1738)) ([ed96fe3](https://github.com/seblyng/codecompanion.nvim/commit/ed96fe33c17b41957f2334b1cae29c24d35f8ef2))
* **adapters:** resolve adapters with correct name ([#1459](https://github.com/seblyng/codecompanion.nvim/issues/1459)) ([0beb918](https://github.com/seblyng/codecompanion.nvim/commit/0beb9183954ae1afa2e1f5a91812706764d1a743))
* **adapters:** resolve not using custom adapter ([#1461](https://github.com/seblyng/codecompanion.nvim/issues/1461)) ([b79b33a](https://github.com/seblyng/codecompanion.nvim/commit/b79b33a58304cd386f72ee0ab159824fa21321c6))
* **adapters:** resolving adapters from prompt library ([#1536](https://github.com/seblyng/codecompanion.nvim/issues/1536)) ([9964f48](https://github.com/seblyng/codecompanion.nvim/commit/9964f4880c66376e4c9f0d45f5fd2ab1e5496254)), closes [#1521](https://github.com/seblyng/codecompanion.nvim/issues/1521)
* **adapters:** stack overflow if default model is function ([#1417](https://github.com/seblyng/codecompanion.nvim/issues/1417)) ([2d28420](https://github.com/seblyng/codecompanion.nvim/commit/2d284203ec63136f72e75a61b1cb19abb31a1ebe)), closes [#1415](https://github.com/seblyng/codecompanion.nvim/issues/1415)
* **adapters:** update HuggingFace endpoint ([#1868](https://github.com/seblyng/codecompanion.nvim/issues/1868)) ([d067c84](https://github.com/seblyng/codecompanion.nvim/commit/d067c846d4f7239c6d3524ea3535f459b18dfd99)), closes [#1864](https://github.com/seblyng/codecompanion.nvim/issues/1864)
* **anthropic:** make sure empty tool calls are dictionaries. ([53b0671](https://github.com/seblyng/codecompanion.nvim/commit/53b0671d0cefc6d91148904e99d080ee4cd303e5))
* **chat:** buffer var with no context ([#1974](https://github.com/seblyng/codecompanion.nvim/issues/1974)) ([0bfe9e2](https://github.com/seblyng/codecompanion.nvim/commit/0bfe9e2be02d3f396ad66c8e8995e0581f4ef65b))
* **chat:** claude code diff and fs/read_text_file fixes ([#2126](https://github.com/seblyng/codecompanion.nvim/issues/2126)) ([b76621b](https://github.com/seblyng/codecompanion.nvim/commit/b76621b1ced981f0ea358b9515e93bf86bb5acb5))
* **chat:** clip claude code tool output ([#2134](https://github.com/seblyng/codecompanion.nvim/issues/2134)) ([b890561](https://github.com/seblyng/codecompanion.nvim/commit/b8905612ccb08d6b4b166dd2508a458c33db7c84))
* **chat:** codeblock formatting in chat buffer ([#1916](https://github.com/seblyng/codecompanion.nvim/issues/1916)) ([3d4d85f](https://github.com/seblyng/codecompanion.nvim/commit/3d4d85f03acc3a31ea2ec9bd34db5194ed7696ff))
* **chat:** correct yank command syntax in keymaps ([#1568](https://github.com/seblyng/codecompanion.nvim/issues/1568)) ([05555a4](https://github.com/seblyng/codecompanion.nvim/commit/05555a40f263488592556c3acfb61ef323805136))
* **chat:** debug window with acp adapters ([#2141](https://github.com/seblyng/codecompanion.nvim/issues/2141)) ([35c591f](https://github.com/seblyng/codecompanion.nvim/commit/35c591f457895f28f244684fa7e744fa3c9438c0))
* **chat:** default completions and add omnifunc ([#1953](https://github.com/seblyng/codecompanion.nvim/issues/1953)) ([bf69033](https://github.com/seblyng/codecompanion.nvim/commit/bf690335d0c6f1370b76a3b0b19c7a8afa3014c1))
* **chat:** don't add duplicate memory ([#2131](https://github.com/seblyng/codecompanion.nvim/issues/2131)) ([669bbdf](https://github.com/seblyng/codecompanion.nvim/commit/669bbdf0940029a08074292d1f31f945af18d0cf))
* **chat:** don't cache blink completions ([#1618](https://github.com/seblyng/codecompanion.nvim/issues/1618)) ([8a958a4](https://github.com/seblyng/codecompanion.nvim/commit/8a958a4a1a11e58f1eb30d378c4c88c611d388d4))
* **chat:** don't remove custom system prompts when using `gs` ([#1770](https://github.com/seblyng/codecompanion.nvim/issues/1770)) ([4e75c62](https://github.com/seblyng/codecompanion.nvim/commit/4e75c629d1c1658c9330a75fd2ffec9cad59ed50)), closes [#1749](https://github.com/seblyng/codecompanion.nvim/issues/1749)
* **chat:** force memory to be added via slash command ([#2140](https://github.com/seblyng/codecompanion.nvim/issues/2140)) ([8899c27](https://github.com/seblyng/codecompanion.nvim/commit/8899c278c2e34108aec573b5f782a6bb7915d83c))
* **chat:** header line when used with prompt library closes [#1319](https://github.com/seblyng/codecompanion.nvim/issues/1319) ([#1327](https://github.com/seblyng/codecompanion.nvim/issues/1327)) ([77ff03d](https://github.com/seblyng/codecompanion.nvim/commit/77ff03d4ce89ca3b4ec06033df4106d11eb536ad))
* **chat:** paths are always relative and wrap context in &lt;attachment&gt; ([#1633](https://github.com/seblyng/codecompanion.nvim/issues/1633)) ([2185ccc](https://github.com/seblyng/codecompanion.nvim/commit/2185ccc81eeb9080f6c856a408ed3cba3f2bb7ef)), closes [#1630](https://github.com/seblyng/codecompanion.nvim/issues/1630) [#1631](https://github.com/seblyng/codecompanion.nvim/issues/1631)
* **chat:** prevent double references in the chat buffer ([#1348](https://github.com/seblyng/codecompanion.nvim/issues/1348)) ([aafbb62](https://github.com/seblyng/codecompanion.nvim/commit/aafbb62c5ceb3f019610fb0e9ed3c04305b59a23))
* **chat:** prevent duplicate # and @ in CoC completions ([#2027](https://github.com/seblyng/codecompanion.nvim/issues/2027)) ([7d9e142](https://github.com/seblyng/codecompanion.nvim/commit/7d9e142a768d3649518515d0827dd7b66c558965))
* **chat:** prevent duplicate # and @ in CoC completions ([#2027](https://github.com/seblyng/codecompanion.nvim/issues/2027)) ([adb3126](https://github.com/seblyng/codecompanion.nvim/commit/adb312667a55fe59a559fd6cf16ecd17b6db6914))
* **chat:** Register cmp completions when filetype is set ([#1560](https://github.com/seblyng/codecompanion.nvim/issues/1560)) ([3d62ac3](https://github.com/seblyng/codecompanion.nvim/commit/3d62ac3ebe840245b157e169d06b8d87ee878dc5))
* **chat:** safely set undolevels ([#2123](https://github.com/seblyng/codecompanion.nvim/issues/2123)) ([5807e04](https://github.com/seblyng/codecompanion.nvim/commit/5807e0457111f0de267fc9a6543b41fae0f5c2b1))
* **chat:** show settings error with acp adapter ([#2065](https://github.com/seblyng/codecompanion.nvim/issues/2065)) ([bf683c3](https://github.com/seblyng/codecompanion.nvim/commit/bf683c3ea033a12f58b3534d5969cec4c29b2602)), closes [#2062](https://github.com/seblyng/codecompanion.nvim/issues/2062)
* **chat:** start_in_insert_mode with telescope ([#1815](https://github.com/seblyng/codecompanion.nvim/issues/1815)) ([dc5eca1](https://github.com/seblyng/codecompanion.nvim/commit/dc5eca177248f5d77e7d01fdd98e18f90ecfcc56))
* **chat:** system prompt resolving ([#2045](https://github.com/seblyng/codecompanion.nvim/issues/2045)) ([c34e496](https://github.com/seblyng/codecompanion.nvim/commit/c34e49676dd9bd44c9a18588167cdc0a31077dbd))
* **chat:** toggling when chat buffer is not in the current tab ([#1725](https://github.com/seblyng/codecompanion.nvim/issues/1725)) ([4f91b4b](https://github.com/seblyng/codecompanion.nvim/commit/4f91b4b6b400b97b923537cb75721b8452cd54dc))
* **chat:** tool folding ([#1811](https://github.com/seblyng/codecompanion.nvim/issues/1811)) ([b506225](https://github.com/seblyng/codecompanion.nvim/commit/b5062255224cb72ee35e374ac764ac53f6fe9fa1))
* **chat:** tools can now be dynamically added ([#1693](https://github.com/seblyng/codecompanion.nvim/issues/1693)) ([3a5f895](https://github.com/seblyng/codecompanion.nvim/commit/3a5f8958197b2e134e7d299673bff76c785dbc99))
* **chat:** tools should be empty table if not used ([#1373](https://github.com/seblyng/codecompanion.nvim/issues/1373)) ([3f72bac](https://github.com/seblyng/codecompanion.nvim/commit/3f72bacfd74fc4e4b4ea07257e61ec6fb3fb004f)), closes [#1371](https://github.com/seblyng/codecompanion.nvim/issues/1371)
* **chat:** unwatch buffers when they're unlisted ([#1809](https://github.com/seblyng/codecompanion.nvim/issues/1809)) ([ea29e11](https://github.com/seblyng/codecompanion.nvim/commit/ea29e112916bad53e52f514bff1bc2e54e2287c2))
* **chat:** various chat buffer fixes ([#1336](https://github.com/seblyng/codecompanion.nvim/issues/1336)) ([1e2f69a](https://github.com/seblyng/codecompanion.nvim/commit/1e2f69a9a65bd716cf897393e7af65fc74907ed8))
* **chat:** watchers use the same diff format as in patch ([#1655](https://github.com/seblyng/codecompanion.nvim/issues/1655)) ([86b1ff1](https://github.com/seblyng/codecompanion.nvim/commit/86b1ff13d140d3b63f49f1cbfd69873b2cbbe40d))
* **chat:** word boundary matching for tools and variables ([#1503](https://github.com/seblyng/codecompanion.nvim/issues/1503)) ([f572601](https://github.com/seblyng/codecompanion.nvim/commit/f57260190a40bb4f071d27c5386eeff1440c111b))
* **deepseek:** inline prompt to chat causes error ([#1406](https://github.com/seblyng/codecompanion.nvim/issues/1406)) ([c912e2d](https://github.com/seblyng/codecompanion.nvim/commit/c912e2d72a91629f554142af3e9a648e54112ca4)), closes [#1405](https://github.com/seblyng/codecompanion.nvim/issues/1405)
* doubled # and @ in CoC completion ([7d9e142](https://github.com/seblyng/codecompanion.nvim/commit/7d9e142a768d3649518515d0827dd7b66c558965))
* doubled # and @ in CoC completion ([adb3126](https://github.com/seblyng/codecompanion.nvim/commit/adb312667a55fe59a559fd6cf16ecd17b6db6914))
* ensure buffer is valid ([#1985](https://github.com/seblyng/codecompanion.nvim/issues/1985)) ([ff248ec](https://github.com/seblyng/codecompanion.nvim/commit/ff248ec17cc1797883ac122e1b3d4a69492b541e)), closes [#1983](https://github.com/seblyng/codecompanion.nvim/issues/1983)
* **inline:** "new" placement doesn't create diffview ([#1343](https://github.com/seblyng/codecompanion.nvim/issues/1343)) ([9ab6ac1](https://github.com/seblyng/codecompanion.nvim/commit/9ab6ac1126d89f74b9882e4343eb1397e4b052da))
* **inline:** chat placements with claude-sonnet-4 ([#1636](https://github.com/seblyng/codecompanion.nvim/issues/1636)) ([0f82355](https://github.com/seblyng/codecompanion.nvim/commit/0f8235523ee555daa6acc6a5e5b5c4472ed60b43)), closes [#1626](https://github.com/seblyng/codecompanion.nvim/issues/1626)
* **inline:** Check result from vim.json.decode pcall ([#2101](https://github.com/seblyng/codecompanion.nvim/issues/2101)) ([d5f4070](https://github.com/seblyng/codecompanion.nvim/commit/d5f40701ca4299300e94910f35342beb47861bcf))
* **inline:** don't modify prompts going to the chat buffer ([#1447](https://github.com/seblyng/codecompanion.nvim/issues/1447)) ([a3b2b63](https://github.com/seblyng/codecompanion.nvim/commit/a3b2b633c6e17f0a891713c724285843c9706e1e))
* **inline:** events are fired with the correct names ([#1919](https://github.com/seblyng/codecompanion.nvim/issues/1919)) ([18cf425](https://github.com/seblyng/codecompanion.nvim/commit/18cf425c837d6e3745b4872d5bf48a2be18b414e))
* **inline:** keymap modes ([#1468](https://github.com/seblyng/codecompanion.nvim/issues/1468)) ([7ac8234](https://github.com/seblyng/codecompanion.nvim/commit/7ac823450c490201af3362a0861c2c1c19b827a8))
* **inline:** parse adapters ([#2069](https://github.com/seblyng/codecompanion.nvim/issues/2069)) ([12c617a](https://github.com/seblyng/codecompanion.nvim/commit/12c617a969f53738f1126a389e8f72f4f754f6c0))
* **inline:** prompting using telescope and dressing in the UI ([#1702](https://github.com/seblyng/codecompanion.nvim/issues/1702)) ([50dde48](https://github.com/seblyng/codecompanion.nvim/commit/50dde48a6a078283c30ec177f7ab3c4eaa350341))
* **inline:** remove blank lines in diffs ([#1565](https://github.com/seblyng/codecompanion.nvim/issues/1565)) ([fee2dd1](https://github.com/seblyng/codecompanion.nvim/commit/fee2dd137b515b779c57c915ca031921e6591d85))
* **inline:** revert keymap changes ([#1622](https://github.com/seblyng/codecompanion.nvim/issues/1622)) ([6f89961](https://github.com/seblyng/codecompanion.nvim/commit/6f89961632defce5a591195851569758a1e15a0e)), closes [#1621](https://github.com/seblyng/codecompanion.nvim/issues/1621)
* **inline:** user moving to other buffer before edits are applied ([#1952](https://github.com/seblyng/codecompanion.nvim/issues/1952)) ([ddfb8cc](https://github.com/seblyng/codecompanion.nvim/commit/ddfb8cc91b4e80e5afb16e832c334d86040ff0c0))
* **inline:** variables ([#1955](https://github.com/seblyng/codecompanion.nvim/issues/1955)) ([4c1cd7e](https://github.com/seblyng/codecompanion.nvim/commit/4c1cd7e5612bc083234877cf3299bb740ee64112)), closes [#1954](https://github.com/seblyng/codecompanion.nvim/issues/1954)
* **openai:** do not send empty tools array ([#1381](https://github.com/seblyng/codecompanion.nvim/issues/1381)) ([33364a0](https://github.com/seblyng/codecompanion.nvim/commit/33364a070f06e3d8cf5276ac409c58de4f922716))
* **prompt_library:** completion in the cmd line ([#1893](https://github.com/seblyng/codecompanion.nvim/issues/1893)) ([e8ab7ef](https://github.com/seblyng/codecompanion.nvim/commit/e8ab7eff9fb61dc7177a1d9bb830886eacbe3114))
* **prompt_library:** custom prompts containing URLs ([#1849](https://github.com/seblyng/codecompanion.nvim/issues/1849)) ([164e95c](https://github.com/seblyng/codecompanion.nvim/commit/164e95c6ff0becd6d152e06be56ccd98f53bc5a8))
* **prompts:** agentic workflow in the config ([#1764](https://github.com/seblyng/codecompanion.nvim/issues/1764)) ([0b3831d](https://github.com/seblyng/codecompanion.nvim/commit/0b3831ddee88a389aa663fb05e35f2724f6df7da))
* **prompts:** reword vectorcode tool in workspace prompt ([#1775](https://github.com/seblyng/codecompanion.nvim/issues/1775)) ([3527a9c](https://github.com/seblyng/codecompanion.nvim/commit/3527a9c85b58a8db2fee6d7dcde72077ba790a4a))
* **prompt:** tags renamed to be tag ([#2115](https://github.com/seblyng/codecompanion.nvim/issues/2115)) ([a869f19](https://github.com/seblyng/codecompanion.nvim/commit/a869f190f627123de8bf97df9e9b5bd6f61645f9))
* **providers:** only use `mini.diff` if initialized ([#1472](https://github.com/seblyng/codecompanion.nvim/issues/1472)) ([f7bb598](https://github.com/seblyng/codecompanion.nvim/commit/f7bb59888b201507a43c856460d455f786c989f8))
* **providers:** register coc execute function ([#1548](https://github.com/seblyng/codecompanion.nvim/issues/1548)) ([92ba84c](https://github.com/seblyng/codecompanion.nvim/commit/92ba84cddf19d936809d9775884699e66a070ec4))
* **providers:** use mini.diff by default if available ([#1368](https://github.com/seblyng/codecompanion.nvim/issues/1368)) ([127a2c1](https://github.com/seblyng/codecompanion.nvim/commit/127a2c1614df2e8565a98e83e3567980c32d9876))
* **references:** don't remove tools by checking chat refs while auto_submitting ([#1320](https://github.com/seblyng/codecompanion.nvim/issues/1320)) ([b2a0aa2](https://github.com/seblyng/codecompanion.nvim/commit/b2a0aa2aa71e0f401099ed88f35cc94e0163aeea))
* **references:** unlock buffer when adding reference after a tool output ([#1477](https://github.com/seblyng/codecompanion.nvim/issues/1477)) ([df44594](https://github.com/seblyng/codecompanion.nvim/commit/df4459401180612bc5b7b167eff7133324e85f1c))
* **refs:** can handle blank messages closes [#1311](https://github.com/seblyng/codecompanion.nvim/issues/1311) ([#1314](https://github.com/seblyng/codecompanion.nvim/issues/1314)) ([c3d2326](https://github.com/seblyng/codecompanion.nvim/commit/c3d2326ec1f1ef9f1a6867d478f3be4930fcdf7d))
* **refs:** do not parse non-existent message ([#1332](https://github.com/seblyng/codecompanion.nvim/issues/1332)) ([c7aeeab](https://github.com/seblyng/codecompanion.nvim/commit/c7aeeaba79c48234f3be61d04f77fe88cf2a7025))
* require tool module path correctly ([#1670](https://github.com/seblyng/codecompanion.nvim/issues/1670)) ([dbefc41](https://github.com/seblyng/codecompanion.nvim/commit/dbefc41dba2f46720ecb6ecec34c0c5f80022f2b))
* **slash_commands:** update adapter reference ([#1502](https://github.com/seblyng/codecompanion.nvim/issues/1502)) ([41108b2](https://github.com/seblyng/codecompanion.nvim/commit/41108b2ee7d71eca50ff6c5008b30a853e14cf35))
* **snacks:** focus on floating chat windows after closing picker ([#1359](https://github.com/seblyng/codecompanion.nvim/issues/1359)) ([6090826](https://github.com/seblyng/codecompanion.nvim/commit/60908265b78145c7c8595d81b36792bc01cd56e5))
* **tools:** `insert_edit_info_file` tool can insert at EOF ([#1650](https://github.com/seblyng/codecompanion.nvim/issues/1650)) ([d54a41a](https://github.com/seblyng/codecompanion.nvim/commit/d54a41a86a510e9c728f6e460801afdf581d69da))
* **tools:** `read_files` tool can read entire file if `end_line` is greater than total lines ([#1824](https://github.com/seblyng/codecompanion.nvim/issues/1824)) ([562950d](https://github.com/seblyng/codecompanion.nvim/commit/562950d1584a1ff603921ec7ce48638e2d7f9e1d))
* **tools:** additional resiliency ([#1987](https://github.com/seblyng/codecompanion.nvim/issues/1987)) ([bc5ec92](https://github.com/seblyng/codecompanion.nvim/commit/bc5ec92b5f4b8542150a6ae2e77422ec50f440a1))
* **tools:** auto submit sends updated buffer ([#1545](https://github.com/seblyng/codecompanion.nvim/issues/1545)) ([82f5917](https://github.com/seblyng/codecompanion.nvim/commit/82f5917455cb7156f36daa99b2ec8049a7958ce5))
* **tools:** auto_submitting processes requests in order ([#1325](https://github.com/seblyng/codecompanion.nvim/issues/1325)) ([0d910ae](https://github.com/seblyng/codecompanion.nvim/commit/0d910ae6ddb4af6e5e2c34838760da241999cd3f))
* **tools:** call subscribers after an LLM response ([#1365](https://github.com/seblyng/codecompanion.nvim/issues/1365)) ([8dc896a](https://github.com/seblyng/codecompanion.nvim/commit/8dc896af23c1e086aee13fe7c850eab365ad337e))
* **tools:** ensure errors are handled throughout implementation ([#1986](https://github.com/seblyng/codecompanion.nvim/issues/1986)) ([705f0cf](https://github.com/seblyng/codecompanion.nvim/commit/705f0cf1d15dabd7db478c4ef751d86744726d2b)), closes [#1940](https://github.com/seblyng/codecompanion.nvim/issues/1940)
* **tools:** error when trying to log nil tool ([#1896](https://github.com/seblyng/codecompanion.nvim/issues/1896)) ([63ce32a](https://github.com/seblyng/codecompanion.nvim/commit/63ce32aa44135ba863aa1e5ed49a0abfdaeb926e))
* **tools:** failed/cancelled/rejected tool calls no longer block the execution queue ([#1852](https://github.com/seblyng/codecompanion.nvim/issues/1852)) ([48d7e8f](https://github.com/seblyng/codecompanion.nvim/commit/48d7e8f6b2fb894afd68e1475bf63d81c934239a)), closes [#1850](https://github.com/seblyng/codecompanion.nvim/issues/1850)
* **tools:** file tool now outputs content to the LLM ([#1321](https://github.com/seblyng/codecompanion.nvim/issues/1321)) ([50ce548](https://github.com/seblyng/codecompanion.nvim/commit/50ce548b099318d6c14c56949d4a3f3a4693b7b1))
* **tools:** files tool can now edit files ([#1317](https://github.com/seblyng/codecompanion.nvim/issues/1317)) ([668fecc](https://github.com/seblyng/codecompanion.nvim/commit/668fecc61777e62a65d624cc88f2a8468ac4cd39))
* **tools:** Handle empty parameters in tools ([ac70519](https://github.com/seblyng/codecompanion.nvim/commit/ac705198a1981316bb6cb461148326e3c8730da8))
* **tools:** list code usages tool ([#2019](https://github.com/seblyng/codecompanion.nvim/issues/2019)) ([31ffde8](https://github.com/seblyng/codecompanion.nvim/commit/31ffde8fc296432d866a877f25084558c78c1806)), closes [#2018](https://github.com/seblyng/codecompanion.nvim/issues/2018)
* **tools:** list code usages tool ([#2019](https://github.com/seblyng/codecompanion.nvim/issues/2019)) ([3c9224e](https://github.com/seblyng/codecompanion.nvim/commit/3c9224e3a0084d6c251b9f81d5cb3c6ac12878e6)), closes [#2018](https://github.com/seblyng/codecompanion.nvim/issues/2018)
* **tools:** make `insert_edit_into_file` more robust for patch markers ([#1653](https://github.com/seblyng/codecompanion.nvim/issues/1653)) ([a6e226c](https://github.com/seblyng/codecompanion.nvim/commit/a6e226ced63d9bb5e601213e63f5cd07ad09f7cd))
* **tools:** multiple bug fixes ([07f7518](https://github.com/seblyng/codecompanion.nvim/commit/07f75181d716a07d683ca66afb8f4dc6b6acbdd3))
* **tools:** patching algorithm can start with an empty line ([#1663](https://github.com/seblyng/codecompanion.nvim/issues/1663)) ([370ec56](https://github.com/seblyng/codecompanion.nvim/commit/370ec56f388fd317fd324d68709e9441d3461896))
* **tools:** patching algorithm now supports lines starting with `-` ([#1654](https://github.com/seblyng/codecompanion.nvim/issues/1654)) ([9011839](https://github.com/seblyng/codecompanion.nvim/commit/9011839a6827b264d632822d9ce17cb66fe95e61))
* **tools:** patching for empty and small files with insufficient context ([#1734](https://github.com/seblyng/codecompanion.nvim/issues/1734)) ([cb55ef0](https://github.com/seblyng/codecompanion.nvim/commit/cb55ef006be3e75015c84fbd9adef14b3546a08f))
* **tools:** tool groups are replaced properly in the chat buffer ([#1364](https://github.com/seblyng/codecompanion.nvim/issues/1364)) ([9402ae3](https://github.com/seblyng/codecompanion.nvim/commit/9402ae373f23269f1baef8ccc32578c128cbf2ed))
* **tools:** tools can now be deleted as references ([#1357](https://github.com/seblyng/codecompanion.nvim/issues/1357)) ([7d0938c](https://github.com/seblyng/codecompanion.nvim/commit/7d0938c1dc117c9c63569a388b9d091ee884d2ce))
* **ui:** add blank line before user role ([#1225](https://github.com/seblyng/codecompanion.nvim/issues/1225)) ([ddda7e8](https://github.com/seblyng/codecompanion.nvim/commit/ddda7e8208856df8c7d32c7fcf6276962ebbb437))
* **ui:** display the correct `sign_text` in floating diffs ([#2031](https://github.com/seblyng/codecompanion.nvim/issues/2031)) ([54b9502](https://github.com/seblyng/codecompanion.nvim/commit/54b9502b796ee18b491f77f24af7209ec80d306a))
* **ui:** display the correct `sign_text` in floating diffs ([#2031](https://github.com/seblyng/codecompanion.nvim/issues/2031)) ([2f21f79](https://github.com/seblyng/codecompanion.nvim/commit/2f21f79fe1791ca4335aca90b4608f434c347855))
* **ui:** enable keymaps in debug chat float for easier quitting ([#1923](https://github.com/seblyng/codecompanion.nvim/issues/1923)) ([5e7d451](https://github.com/seblyng/codecompanion.nvim/commit/5e7d451098f61afdb13710844aaf0d83530e4128))
* **ui:** floating diff style ([#2035](https://github.com/seblyng/codecompanion.nvim/issues/2035)) ([483d0c0](https://github.com/seblyng/codecompanion.nvim/commit/483d0c0a91f0cad3ed2a1728d8c088c1b7e414ff))
* **ui:** floating diff style ([#2035](https://github.com/seblyng/codecompanion.nvim/issues/2035)) ([3e8188f](https://github.com/seblyng/codecompanion.nvim/commit/3e8188f87465c851b2e8f081f714928d6577675f))
* **ui:** handle custom winborder characters ([#1915](https://github.com/seblyng/codecompanion.nvim/issues/1915)) ([9e23ef1](https://github.com/seblyng/codecompanion.nvim/commit/9e23ef19429e17d68c0bda28c687b85b6741e666))
* **ui:** include `kind` option in all `vim.ui.select` calls ([#1456](https://github.com/seblyng/codecompanion.nvim/issues/1456)) ([9d8fc51](https://github.com/seblyng/codecompanion.nvim/commit/9d8fc51a1923333de683ebf85c633fd003ad2b9b))
* **ui:** reduce delay in using `gr` to reject diff ([#1917](https://github.com/seblyng/codecompanion.nvim/issues/1917)) ([55c29d9](https://github.com/seblyng/codecompanion.nvim/commit/55c29d920380c5a83ca00902dd5d3c3dd22a9211))
* **ui:** snacks being completely ignored ([#2010](https://github.com/seblyng/codecompanion.nvim/issues/2010)) ([fed4a5d](https://github.com/seblyng/codecompanion.nvim/commit/fed4a5ddd79f92357a2320e4bcff0d56c46fc9b6)), closes [#2009](https://github.com/seblyng/codecompanion.nvim/issues/2009)
* **ui:** snacks being completely ignored ([#2010](https://github.com/seblyng/codecompanion.nvim/issues/2010)) ([b02a7da](https://github.com/seblyng/codecompanion.nvim/commit/b02a7da50e8d1ee473a31f79152dcdf8f7abf5d5)), closes [#2009](https://github.com/seblyng/codecompanion.nvim/issues/2009)
* **ui:** tool spacing in chat buffer ([#1962](https://github.com/seblyng/codecompanion.nvim/issues/1962)) ([a61730e](https://github.com/seblyng/codecompanion.nvim/commit/a61730e84f92453390a4e1250482033482c33e84))
* **utils:** fallback to vim.highlight ([#1611](https://github.com/seblyng/codecompanion.nvim/issues/1611)) ([6d62e18](https://github.com/seblyng/codecompanion.nvim/commit/6d62e1843cbee7a181a5b86de9e4ec554650d8d9))
* **variables:** ensure special chars are matched ([#1470](https://github.com/seblyng/codecompanion.nvim/issues/1470)) ([a682004](https://github.com/seblyng/codecompanion.nvim/commit/a682004d4ff97c0450617975699bfc78029862be))
* **workflows:** ensure references are rendered ([#1376](https://github.com/seblyng/codecompanion.nvim/issues/1376)) ([598a444](https://github.com/seblyng/codecompanion.nvim/commit/598a4443e2906a382bc182e5558371ea2dd3df64))
* **workflows:** successive prompts and tools now work ([#1508](https://github.com/seblyng/codecompanion.nvim/issues/1508)) ([0112caf](https://github.com/seblyng/codecompanion.nvim/commit/0112caf54a79bb6cfbcb6e67cd16a3a9f18af9a7)), closes [#1496](https://github.com/seblyng/codecompanion.nvim/issues/1496)
* **workspace:** add description to buffer content ([#1713](https://github.com/seblyng/codecompanion.nvim/issues/1713)) ([ff939d1](https://github.com/seblyng/codecompanion.nvim/commit/ff939d18d8d64b0bef985aeb9be26f57e4ee8837))


### Performance Improvements

* **chat:** improve system prompt resolution ([#2050](https://github.com/seblyng/codecompanion.nvim/issues/2050)) ([6bc1f9f](https://github.com/seblyng/codecompanion.nvim/commit/6bc1f9f6d9f4ac71545b4883caf93181cadf6146))
* **chat:** set undolevels to 10 ([#2022](https://github.com/seblyng/codecompanion.nvim/issues/2022)) ([3cf980e](https://github.com/seblyng/codecompanion.nvim/commit/3cf980e36db2f7136079d73b927908cedd5863c6))
* **chat:** set undolevels to 10 ([#2022](https://github.com/seblyng/codecompanion.nvim/issues/2022)) ([94784eb](https://github.com/seblyng/codecompanion.nvim/commit/94784eb7050ad349870a0d0f2331fcd9d408d5cc))


### Code Refactoring

* **chat:** move `opts.goto_file_action` to `strategies.chat.opts` ([#1571](https://github.com/seblyng/codecompanion.nvim/issues/1571)) ([cdf7721](https://github.com/seblyng/codecompanion.nvim/commit/cdf772165782e55a451c0793bf4c2a89926b89bd))
* **chat:** move the `goto_file_action` to `strategies.chat.opts` ([cdf7721](https://github.com/seblyng/codecompanion.nvim/commit/cdf772165782e55a451c0793bf4c2a89926b89bd))
* **chat:** tools and variables now use `@{tool}` and `#{variable}` syntax ([#1740](https://github.com/seblyng/codecompanion.nvim/issues/1740)) ([f89eca2](https://github.com/seblyng/codecompanion.nvim/commit/f89eca26368b29bc8259921d459c1b4e5bfaeebb))
* remove support for nvim-0.10 ([#1639](https://github.com/seblyng/codecompanion.nvim/issues/1639)) ([5d0ef43](https://github.com/seblyng/codecompanion.nvim/commit/5d0ef43ed822ea3341ed0989e45f2d10d57ba359))
